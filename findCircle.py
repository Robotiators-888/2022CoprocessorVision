...
while True :
    ...
    # if (type(frame) == None):if (img_path == None):
#     try:
#         camera = cv2.VideoCapture(0)
#     except Exception as e:
#         print(e)
...
#         exit()
    ...
    lower_color = np.array([ValueMap[('hue', 'slider')], ValueMap[('sat', 'slider')], ValueMap[('val', 'slider')]])
    upper_color = np.array([ValueMap[('hue2', 'slider2')], ValueMap[('sat2', 'slider2')], ValueMap[('val2', 'slider2')]])
    nothing = 0
